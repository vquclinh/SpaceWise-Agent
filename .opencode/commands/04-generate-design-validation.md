...
5. **Audit Policy:** After generation, you MUST follow the repository audit policy (AGENTS.md section 8). Create a new audit log in `docs/audits/` using the `docs/audits/AUDIT_TEMPLATE.md` format.